...
async function createAppointment(formData: FormData) {
  ...
  if (newClient) {
    // Cria a data usando o horário do seu PC e converte para o padrão Universal do Banco
...
export default async function NewAppointment(props: PageProps) {
  ...
  // Uso do helper function para garantir string
  const safeDate = getSafeDate(params.date);
  
  // Agora safeDate é string garantida
  const formattedDate = format(new Date(safeDate), "d 'de' MMMM", { locale: ptBR });
