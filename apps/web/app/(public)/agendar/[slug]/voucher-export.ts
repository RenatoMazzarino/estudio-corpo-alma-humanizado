...
export const renderVoucherImageBlob = async (node: HTMLElement) => {
...
export const downloadVoucherBlob = (blob: Blob, filename: string, userAgent: string) => {
...
export const shareVoucherBlob = async (
  blob: Blob,
  filename: string,
