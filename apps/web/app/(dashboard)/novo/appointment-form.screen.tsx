    ...
    <form ref={formRef} action={formAction} className="space-y-6">
      ...
      {!isEditing && isStep4Unlocked && (
        <AppointmentFinanceStep
          ...
          financeExtraItems={financeExtraItems}
          ...
          financeNewItemLabel={financeNewItemLabel}
          financeNewItemAmount={financeNewItemAmount}
          ...
          scheduleDiscountValue={scheduleDiscountValue}
          ...
          hasChargeNowAmountModeChoice={hasChargeNowAmountModeChoice}
          onChangeChargeNowAmountMode={(value) => {
            setChargeNowAmountMode(value);
            setHasChargeNowAmountModeChoice(true);
          }}
          effectiveSignalPercentageDraft={effectiveSignalPercentageDraft}
          chargeNowSuggestedSignalAmount={chargeNowSuggestedSignalAmount}
          chargeNowCustomAmount={chargeNowCustomAmount}
          ...
          chargeNowSignalValueConfirmed={chargeNowSignalValueConfirmed}
