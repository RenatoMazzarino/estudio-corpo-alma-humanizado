          ...
          {isSuccessState ? (
            ...
            <>
              ...
              <AttendancePaymentMethodSection
                method={method}
                hideWaiverOption={hideWaiverOption}
                isWaived={isWaived}
                waiverSuccess={waiverSuccess}
                ...
                pixRemaining={pixRemaining}
                pixKeyConfigured={pixKeyConfigured}
                pixKeyType={pixKeyType}
                normalizedPixKeyValue={normalizedPixKeyValue}
                pixKeyGenerating={pixKeyGenerating}
                pixKeyQrDataUrl={pixKeyQrDataUrl}
                pixKeyCode={pixKeyCode}
                ...
                onCreatePix={() => void handleCreatePix()}
                onCopyPix={() => void handleCopyPix()}
                onCopyPixKey={() => void handleCopyPixKey()}
                onRegisterCash={() => void handleRegisterCash()}
                onRegisterPixKey={() => void handleRegisterPixKey()}
                onPointCharge={(cardMode) => void handlePointCharge(cardMode)}
                onWaiveAsCourtesy={() => void handleWaiveAsCourtesy()}
              />
            </>
          )}
        </div>
