          ...
          {isOngoing ? (
            <button 
              onClick={async () => {
                ...
                showToast(feedbackById("generic_saved", { tone: "success", message: "Atendimento finalizado." }));
              }}
            ...
            <button 
              onClick={async () => {
                ...
                showToast(feedbackById("generic_saved", { tone: "success", message: "Atendimento iniciado." }));
              }}
