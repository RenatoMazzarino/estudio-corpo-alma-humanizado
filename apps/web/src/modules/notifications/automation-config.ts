...
export const WHATSAPP_AUTOMATION_META_USE_HELLO_WORLD_TEMPLATE = parseBoolean(
  process.env.WHATSAPP_AUTOMATION_META_USE_HELLO_WORLD_TEMPLATE,
  false
);
...
export const WHATSAPP_AUTOMATION_META_HELLO_WORLD_TEMPLATE_NAME =
  process.env.WHATSAPP_AUTOMATION_META_HELLO_WORLD_TEMPLATE_NAME?.trim() || "hello_world";
export const WHATSAPP_AUTOMATION_META_HELLO_WORLD_TEMPLATE_LANGUAGE =
  process.env.WHATSAPP_AUTOMATION_META_HELLO_WORLD_TEMPLATE_LANGUAGE?.trim() || "en_US";
