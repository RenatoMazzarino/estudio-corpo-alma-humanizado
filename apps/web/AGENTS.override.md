...
5. Em fluxo realtime, nao introduzir `router.refresh()` global sem justificativa
   tecnica e fallback medido.
...
5. `pnpm --filter web test:smoke` quando houver impacto em fluxo usuario ou
   rotas publicas.
