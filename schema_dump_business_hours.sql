...
ALTER TABLE ONLY "public"."business_hours"
    ADD CONSTRAINT "business_hours_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id");
...
CREATE POLICY "Escrita total horarios" ON "public"."business_hours" TO "authenticated" USING (true);



CREATE POLICY "Leitura autenticada horarios" ON "public"."business_hours" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Leitura publica horarios" ON "public"."business_hours" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Permitir agendamento publico" ON "public"."appointments" FOR INSERT TO "anon" WITH CHECK (true);



CREATE POLICY "Permitir leitura publica services" ON "public"."services" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Permitir leitura publica tenants" ON "public"."tenants" FOR SELECT TO "anon" USING (true);
