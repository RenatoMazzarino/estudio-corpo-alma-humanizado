...
3. Evitar duplicar instrucoes completas do `AGENTS.md` raiz; aqui so complementar o uso da skill.

## Validacao

1. Sempre que alterar a skill, validar sintaxe/estrutura da skill com tooling disponivel.
