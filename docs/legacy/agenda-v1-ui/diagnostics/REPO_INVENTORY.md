...
> **Status documental:** Historico/legado. Use apenas para contexto e
> rastreabilidade.
> **Nao canonico:** Para comportamento atual do sistema, valide
...
- **Packages**: `packages/ui`, `packages/eslint-config`,
