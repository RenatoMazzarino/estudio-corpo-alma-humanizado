...
Esta pasta guarda _dumps_ de schema usados para **documentação/auditoria**. Eles
**não** são fonte de verdade de evolução do banco.
...
Por que existem arquivos aqui (ex.: `schema_dump_clients.sql`,
...
- Decisões de layout e padrões de tela:
