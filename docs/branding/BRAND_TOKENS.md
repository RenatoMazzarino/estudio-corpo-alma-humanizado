...
- Studio/fluxo padrão:
  - usar classes baseadas em `studio-green` (`bg-studio-green`,
    `text-studio-green`, `border-studio-green`).
- Atendimento em domicílio:
  - usar classes baseadas em `dom` (`bg-dom/...`, `border-dom/...`,
    `text-dom-strong`).
...
- Preferir sempre classes derivadas dos tokens acima para evitar regressão
  visual.
