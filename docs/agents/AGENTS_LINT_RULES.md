...
4. Todo `AGENTS.override.md` possui secao `## Regras` (ou `## Regras especificas`).
5. Todo `AGENTS.override.md` possui secao `## Regra de maturidade (V1 final de producao)`.
...
1. O lint de agentes valida consistencia estrutural; ele nao substitui revisao de conteudo.
