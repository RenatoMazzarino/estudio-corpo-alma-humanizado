-- Fix ambiguous overload for create_public_appointment by moving p_client_email
-- before optional parameters and removing default overlap with legacy signature.
